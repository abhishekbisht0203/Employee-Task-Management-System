...
if exist %WRAPPER_JAR% (
    ...
    powershell -Command "&{"^
		...
		"}"
    if "%ERRORLEVEL%" == "0" goto downloadJarFinished
)
if exist %WRAPPER_JAR% (
    goto runMaven
) else (
    echo Failed to download maven-wrapper.jar - please install Maven manually or add .mvn/wrapper/maven-wrapper.jar
    goto error
)
